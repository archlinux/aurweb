...
class ClosureFactory:
    ...
    def _adoption_closure(
        self, requester: User, pkgbase: PackageBase, target: PackageBase | None = None
    ):
        return f"[Autogenerated] Accepted adoption for {pkgbase.Name}."

    def _rejected_adoption_closure(
        self, requester: User, pkgbase: PackageBase, target: PackageBase | None = None
    ):
        return f"[Autogenerated] Rejected adoption for {pkgbase.Name}."
